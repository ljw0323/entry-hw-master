    ...
    return {
        ko: {
            template: {
                ...
                arduino_nano_get_lidar_value: '라이더 센서의 RX %1 TX %2 센서값',
                ...
                arduino_nano_set_lidar: '디지털 %1 번 핀의 라이더 센서를 %2 의 거리로 정하기 %3',
                arduino_nano_get_digital: '디지털 %1 번 센서값',
                arduino_nano_set_blink: '디지털 %1 번 핀을 %2 초 간격으로 깜박이게 하기',
            },
        },
        en: {
            template: {
                ...
                arduino_nano_get_lidar_value: 'Read lidar sensor Rx pin %1 TX pin %2',
                ...
                arduino_nano_set_lidar: 'Set lidar pin %1 distence as %2 %3',
...
Entry.ArduinoNano.blockMenuBlocks = [
    ...
    'arduino_nano_get_lidar_value',
    'arduino_nano_set_lidar',
...
Entry.ArduinoNano.getBlocks = function() {
    return {
        ...
        arduino_nano_get_lidar_value: {
            template: Lang.template.arduino_ext_get_lidar_value,
            parent: 'arduino_ext_get_lidar_value',
            def: {
                params: [
                    {
                        type: 'arduino_get_port_number',
                ...
                type: 'arduino_nano_get_lidar_value',
            },
            isNotFor: ['ArduinoNano'],
            syntax: undefined,
        },
